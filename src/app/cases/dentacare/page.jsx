			...
			<div className="case dentacare">
					...
					<div className="wrapper">
						<div>
							<div className="case-logo-left wow fadeInUp">
								<h2>Логотип</h2>
								<p>Нами был разработан узнаваемый символ для стоматологии "DentaCare". Дизайнер создал
									все элементы в Adobe Illustrator, чтобы обеспечить векторное представление
									логотипа.</p>
							</div>
				...
				<div className="case-images">
					<div className="case-devices">
						<Image width="1252" height="725" className="wow fadeInUp" src="/img/content/dentacare-1.jpg"
							   alt="" />
						<Image width="293" height="604" className="wow fadeInUp" data-wow-delay="0.2s"
							   src="/img/content/dentacare.png" alt="" />
					</div>
				</div>
						...
						<div className="case-step-items">
							<div className="case-step-item wow fadeInUp">
								...
								<div className="case-step-desc">
									Продумали и согласовали с клиентом архитектуру страниц будущего сайта "DentaCare".
									Затем мы приступили к написанию текстов. Мы выбрали официальный, но при этом
									дружелюбный тон для общения клиники с клиентами разных поколений, поскольку целевая
									аудитория в данной
							...
							<div className="case-step-item wow fadeInUp">
								...
								<div className="case-step-desc">Разработали концепцию, выбрали цветовую палитру, шрифты
									и стили. Создали макет (wireframe) для каждой страницы, определяющий расположение
									элементов. Создали визуальные элементы, такие как иконки и фоны.
								</div>
							</div>
							<div className="case-step-item wow fadeInUp">
								...
								<div className="case-step-desc">
									Всё началось с создания HTML-кода, который определяет структуру и контент страницы.
									Затем, после верстки, разработали структуру базы данных, которая будет хранить
									информацию, необходимую для сайта. Также важной частью процесса была разработка
									системы управления
									контентом на сайте.
								</div>
							</div>
							<div className="case-step-item wow fadeInUp">
								...
								<div className="case-step-desc">После завершения верстки и программирования проводились
									тесты для обнаружения и исправления ошибок и недоразумений. Проводилось тестирование
									как фронтенда, так и бэкенда, включая проверку взаимодействия между ними.
								</div>
							</div>
							<div className="case-step-item wow fadeInUp">
								<div className="case-step-number">05</div>
								<div className="case-step-title">Оптимизация</div>
								<div className="case-step-desc">Осуществили оптимизацию сайта с целью улучшения
									производительности, увеличения скорости загрузки страниц и оптимизации изображений.
									Также обеспечили безопасность сайта путем внедрения мер по защите от атак и
									уязвимостей.
								</div>
							</div>
						</div>
						...
						<div>
							...
							<div className="case-context-items">
								<div className="case-context-item wow fadeInUp" data-wow-delay="0.2s">
									...
									<p>Определили через поисковые запросы, как потенциальные клиенты выбирают
										стоматологические услуги, и создали для них подходящую рекламу</p>
								</div>
								<div className="case-context-item wow fadeInUp" data-wow-delay="0.4s">
									...
									<p>Определили цели, которые мы хотим достичь с помощью контекстной рекламы.
										Идентифицировали ЦА, определили ее характеристики и потребности.</p>
								</div>
								<div className="case-context-item wow fadeInUp" data-wow-delay="0.3s">
									...
									<p>Провели исследование ключевых слов, связанных с нишей. Использовали инструменты,
										такие как Google Keyword Planner.</p>
								</div>
								<div className="case-context-item wow fadeInUp" data-wow-delay="0.5s">
									...
									<p>Создали новую кампанию в Google Ads и Яндекс.Директ, определив параметры, такие
										как бюджет, расписание, регионы и цели кампании.</p>
								</div>
							</div>
						</div>
					</div>
