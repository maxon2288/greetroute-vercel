		...
		<>
			<div>
				...
				<div className="reason-top">
					<h2>Сайты для успешной лидогенерации, <br /> <span>на понятном, продающем языке</span>
					</h2>
					<p>
				...
				<div className="reason-items">
					<div className="reason-item" data-wow-delay="0.3s">
					...
					<div className="reason-item" data-wow-delay="0.5s">
					...
					<div className="reason-item" data-wow-delay="0.7s">
