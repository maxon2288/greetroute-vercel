	...
	render() {
		const panels = [
			...
			},
			{
				...
				content: "Да, мы предоставляем поддержку сайта после запуска, обеспечивая непрерывную работу, обновления и техническую помощь нашим клиентам."
			},
			{
		...
		return (
			<div className="faq-items" role="tablist">
				{panels.map((panel, index) => (
					<Panel key={index} activeTab={activeTab} index={index} {...panel}
