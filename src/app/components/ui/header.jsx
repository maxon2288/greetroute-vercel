				...
				<div className="wrapper">
					<div>
						<Link href="/" className="header-logo">
							<img width="227" height="32" src="/img/svg/header-logo.svg" alt="" />
						</Link>
									...
									<ul>
										<li>
											<Link href="/services/web">
												<div>
													<Image width="18" height="18" src="/img/svg/header-serv-1.svg"
														   alt="" />
													<h3>Разработка сайта</h3>
												</div>
												<p>Этап воронки продаж. Разработка инструмента сбора заявок для вашего
													продукта</p>
											</Link>
											<Link href="/services/branding">
												<div>
													<Image width="18" height="18" src="/img/svg/header-serv-2.svg"
														   alt="" />
													<h3>Брендинг</h3>
												</div>
											...
											<Link href="/services/context">
												<div>
													<Image width="18" height="18" src="/img/svg/header-serv-5.svg"
														   alt="" />
