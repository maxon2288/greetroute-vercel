	...
	return (
		<>
			...
			<meta name="description"
				  content="UI/UX Дизайн для вашего сайта. Оставьте заявку и мы вас проконсультируем!" />
					...
					<div className="serv-items-content">
						<div className="serv-items">
							...
							<div className="serv-item popular wow fadeInUp" data-wow-delay="0.4s">
								<h3>Сайт компании</h3>
								<span>от 100$</span>
								<p>Разработка UI-элементов в Figma. Набор страниц таких как услуги, о нас, контакты,
									блог</p>
								<Link href="/#form">
									Заказать
									<img src="/img/svg/serv-icon.svg" alt="" />
							...
							<div className="serv-item wow fadeInUp" data-wow-delay="0.6s">
								<h3>Платформа</h3>
								<span>от $400</span>
								<p>UX-проектирование структуры страниц и элементов, дизайн в Figma, кастомизация
									структуры под логику работы сайта </p>
								<Link href="/#form">
									Заказать
									<img src="/img/svg/serv-icon.svg" alt="" />
								</Link>
